...
test("removeAt函数输入数组和合法的下标",function(){
	...
	var arraytest = [2,4,6,9,'name','job'];
        ...
        ok(UserAction.isEqualArray(arraytest,array),"删除数组元素后");
        
        arraytest = [2,4,6,9,'name','job'];
        r = baidu.array.removeAt(arraytest, 5);
        equal(r,'job',"删除数组项job");
        array = [2,4,6,9,'name'];
        ok(UserAction.isEqualArray(arraytest,array),"删除数组项后");
})
test("removeAt函数输入数组和下标的边界值",function(){
	...
	var arraytest = [4,6,8,'one','two',10,11];
        ...
        ok(UserAction.isEqualArray(arraytest,array),"删除下边界下标的数组元素后");
        
        var r = baidu.array.removeAt(arraytest, 5);
        array = [6,8,'one','two',10];
        equal(r,11,"删除数组元素11");
        ok(UserAction.isEqualArray(arraytest,array),"删除上边界下标的数组后");
})
...
test("removeAt函数输入数组和下标-1",function(){
	expect(2);
	   var arraytest = [4,6,8,'one','two',10,11];
        ...
        equal(r,11,"删除数组元素11");
        ok(UserAction.isEqualArray(arraytest,array),"删除数组下标为-1");
})
...
test("removeAt函数输入数组和下标超过数组长度",function(){
	expect(2);
        ...
        ok(UserAction.isEqualArray(arraytest,array),"下标超过数组长度");
})
...
test("removeAt函数输入数组和负数下标（超出数组长度）",function(){
	   var arraytest = [4,6,8,'one','two',10,11];
        ...
        var array = [6,8,'one','two',10,11];
        ok(UserAction.isEqualArray(arraytest,array),"负数下标下标超过数组长度");
})
