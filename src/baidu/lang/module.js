 ...
 * @function
 * @grammar baidu.lang.module(name, module[, opt_owner])
 * @param {string} name 需要创建的模块名.
 * @param {Any} module 需要创建的模块对象.
 * @param {Object=} opt_owner 模块创建的目标环境，默认为window.
 * @remark
 *
 ...
 * @meta standard
 */
baidu.lang.module = function(name, module, opt_owner) {
    var packages = name.split('.'),
        len = packages.length - 1,
        packageName,
        i = 0
        owner = opt_owner || window;
